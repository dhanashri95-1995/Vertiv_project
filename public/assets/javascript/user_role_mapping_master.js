        ...
        success: function (result) {
          ...
          $('#userroletbl').DataTable({
            ...
            'aoColumns': [
              ...
              {
              //  ' + result.data[i].s_first_name + ' ' + result.data[i].s_last_name + '
              // 'render': function(data, type, row, meta) {
                // return '<b>' + row.s_first_name + ' ' + row.s_last_name + '</b>';
                'data': 'username'
              // }
              },
              {
      ...
      $.ajax({
        ...
        success: function (result) {
          ...
          for (var i = 0; i < result.data.length; i++) {
            userdrp += '<option value="' + result.data[i].s_user_id + '">' + result.data[i].s_first_name + ' ' + result.data[i].s_last_name + '</option>';
          }
